---
name: website-design-workshop-portable
...
> **Invoke with:** `/website-design-workshop-portable` | **Keywords:** website workshop, design consultation, brand brief, stitch prompt, website planning
...
|----------|---------|-------------|
| [session-log.md](assets/session-log.md) | Overall session log | Created at session start |
| [discussion-log.md](assets/discussion-log.md) | Per-brand discussion log | Created per brand at session start |
| [brand-brief.md](assets/brand-brief.md) | Structured brand brief | Generated when enough data is captured |
| [stitch-prompt.md](assets/stitch-prompt.md) | Individual Stitch prompt | Generated per page per brand |
...
2. Generate/update brand-brief.md from the brand-brief template
...
3. Save each prompt to `stitch-prompts/{page-name}-v1.md` using the stitch-prompt template
