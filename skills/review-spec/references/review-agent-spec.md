...
> Review checklist for specs produced by `agent-spec-builder`. The spec is a folder containing `manifest.yaml`, `overview.md`, team/agent specs, and optionally shared documents.
...
## Instance Parity Check (Template-to-Instances only)

### Check 15: Instance Parity
