...
2. **Run Model Tier Validation:** Cross-check each agent's proposed model tier against its role (see Post-Generation Validation Check 4). Flag contradictions before presenting to user.
